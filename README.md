...
Создайте файл `.env` в каталоге `star_burger/` и определите следующие переменные окружения:
- SECRET_KEY (например большое случайное число)
- YANDEX_API - этот токен необходим для использования инструментов определения геолокации реализованы на базе сервисов Яндекса
